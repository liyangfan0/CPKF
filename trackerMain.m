    ...
    for frame = 1:num_frames
	    ...
	    %% TESTING step
            ...
            for i=1:num_particle
                ...
                [particle{i}{1},particle{i}{2},particle{i}{3},particle{i}{4},particle{i}{5},particle{i}{6},particle{i}{7}]=...
                 my_response(particle{i}{4},particle{i}{5},Q,R,A,C,particle{i}{2},particle{i}{3},particle{i}{1},p,im,bg_area,area_resize_factor,w2c,hann_window,hf_num_hog,hf_num_cn,hf_den_hog,hf_den_cn,bg_hist,fg_hist);
